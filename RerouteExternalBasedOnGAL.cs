...
namespace MassMailingPaaSOnPremConnector
{
    ...
    public class RerouteExternalBasedOnGAL : RoutingAgentFactory
    {
        ...
        {
            return new MassMailingPaaSOnPremConnector_RerouteExternalBasedOnGAL(server.AddressBook);
        }
    }

    public class MassMailingPaaSOnPremConnector_RerouteExternalBasedOnGAL : RoutingAgent
    {
        static string EventLogName = "RerouteExternalBasedOnGAL";
        ...
        static readonly string RegistryHive = @"Software\TransportAgents\MassMailingPaaSOnPremConnector\RerouteExternalBasedOnGAL";
        ...
        static readonly string MassMailingPaaSOnPremConnectorNameValue = "MassMailingPaaSOnPremConnector-RerouteExternalBasedOnGAL";
        ...
        public MassMailingPaaSOnPremConnector_RerouteExternalBasedOnGAL(AddressBook serverAddressBook)
        {
        ...
        void RerouteExternalBasedOnGAL(ResolvedMessageEventSource source, QueuedMessageEventArgs evtMessage)
        {
            try
            {
                ...
                EventLog.AppendLogEntry(String.Format("Processing message {0} from {1} with subject {2} in MassMailingPaaSOnPremConnector:RerouteExternalBasedOnGAL", messageId, sender, subject));
                ...
                EventLog.AppendLogEntry(String.Format("MassMailingPaaSOnPremConnector:RerouteExternalBasedOnGAL took {0} ms to execute", stopwatch.ElapsedMilliseconds));
            ...
            {
                EventLog.AppendLogEntry("Exception in MassMailingPaaSOnPremConnector:RerouteExternalBasedOnGAL");
